...
export default function AIAssistant() {
  ...
  return (
    <>
      ...
      <div className="fixed z-[70] flex flex-col items-end gap-2" style={{ bottom: 'calc(1.5rem + env(safe-area-inset-bottom))', right: 'calc(1.5rem + env(safe-area-inset-right))' }}>
      ...
      {/* Active Popup Widget */}
      {isOpen && (
        <div className="fixed w-[calc(100vw-1rem)] h-[calc(100vh-6rem)] sm:w-[520px] sm:h-[700px] max-w-[calc(100vw-2rem)] max-h-[calc(100vh-7rem)] bg-white rounded-xl shadow-2xl border-2 border-green-200 z-[80] flex flex-col animate-slide-up" style={{ bottom: 'calc(6rem + env(safe-area-inset-bottom))', right: 'calc(1.5rem + env(safe-area-inset-right))' }}>
