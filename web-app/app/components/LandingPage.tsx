  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <p className="mb-3 font-semibold text-red-600">Latest Updates</p>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Parliamentary News & Updates
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Stay informed with the latest parliamentary proceedings, legislative updates, and important announcements.
            </p>
          </div>
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-lg transition-shadow duration-300">
              ...
              <div className="p-6">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-2">
                  New Education Bill Passes Second Reading
                </h3>
                <p className="text-gray-600 mb-4">
                  The comprehensive education reform bill has successfully passed its second reading with overwhelming support from both sides of the house.
                </p>
                <div className="flex items-center">
                  <div className="w-10 h-10 bg-gradient-to-r from-red-600 via-yellow-500 to-green-600 rounded-full flex items-center justify-center mr-3">
                    <span className="text-white font-bold text-sm">GH</span>
                  </div>
                  <div>
                    <p className="text-sm font-semibold text-gray-900">Parliamentary Reporter</p>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-lg transition-shadow duration-300">
              ...
              <div className="p-6">
                <div className="flex items-center mb-3">
                  <span className="inline-block px-3 py-1 text-xs font-semibold text-yellow-600 bg-yellow-100 rounded-full">
                    Committee
                  </span>
                </div>
                <h3 className="text-lg font-bold text-gray-900 mb-2">
                  Health Committee Reviews Healthcare Budget
                </h3>
                <p className="text-gray-600 mb-4">
                  The Health Committee conducted a comprehensive review of the proposed healthcare budget allocation for the upcoming fiscal year.
                </p>
                <div className="flex items-center">
                  <div className="w-10 h-10 bg-gradient-to-r from-red-600 via-yellow-500 to-green-600 rounded-full flex items-center justify-center mr-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-gray-900">Health Committee</p>
                    <div className="flex items-center text-sm text-gray-500">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-lg transition-shadow duration-300">
              ...
              <div className="p-6">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-2">
                  New Digital Parliament Initiative Launched
                </h3>
                <p className="text-gray-600 mb-4">
                  Parliament announces a new digital initiative to enhance transparency and public engagement in legislative processes.
                </p>
                <div className="flex items-center">
                  <div className="w-10 h-10 bg-gradient-to-r from-red-600 via-yellow-500 to-green-600 rounded-full flex items-center justify-center mr-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-gray-900">Digital Parliament</p>
                    <div className="flex items-center text-sm text-gray-500">
